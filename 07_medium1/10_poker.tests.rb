...
# Mock to enable setting test cards directly:
class DeckMock < Deck
...
hand_royal_flush = PokerHand.new(DeckMock.create([
                                                   Card.new(10, 'Hearts'),
                                                   Card.new('Ace', 'Hearts'),
...
hand_straight_flush_queen_high = PokerHand.new(DeckMock.create([
                                                                 Card.new(8, 'Clubs'),
                                                                 Card.new(9, 'Clubs'),
...
hand_straight_flush_nine_high = PokerHand.new(DeckMock.create([
                                                                Card.new(5, 'Clubs'),
                                                                Card.new(6, 'Clubs'),
                                                                Card.new(9, 'Clubs'),
                                                                Card.new(7, 'Clubs'),
...
hand_four_of_a_kind_six_high = PokerHand.new(DeckMock.create([
                                                               Card.new(6, 'Diamonds'),
                                                               Card.new(6, 'Hearts'),
                                                               Card.new(5, 'Diamonds'),
                                                               Card.new(6, 'Spades'),
...
hand_four_of_a_kind_three_high = PokerHand.new(DeckMock.create([
                                                                 Card.new(3, 'Hearts'),
                                                                 Card.new(3, 'Clubs'),
                                                                 Card.new(5, 'Diamonds'),
                                                                 Card.new(3, 'Spades'),
...
hand_full_house_three_fives_and_two_kings = PokerHand.new(DeckMock.create([
                                                                            Card.new(5, 'Hearts'),
                                                                            Card.new(5, 'Clubs'),
...
hand_full_house_three_fours_and_two_aces = PokerHand.new(DeckMock.create([
                                                                           Card.new(4, 'Hearts'),
                                                                           Card.new(4, 'Clubs'),
...
hand_full_house_three_fours_and_two_fives = PokerHand.new(DeckMock.create([
                                                                            Card.new(4, 'Hearts'),
                                                                            Card.new(4, 'Clubs'),
                                                                            Card.new(5, 'Diamonds'),
                                                                            Card.new(4, 'Spades'),
...
hand_flush_ace_high = PokerHand.new(DeckMock.create([
                                                      Card.new(10, 'Hearts'),
                                                      Card.new('Ace', 'Hearts'),
                                                      Card.new(2, 'Hearts'),
                                                      Card.new('King', 'Hearts'),
...
hand_flush_ten_high = PokerHand.new(DeckMock.create([
                                                      Card.new(10, 'Clubs'),
                                                      Card.new(2, 'Clubs'),
                                                      Card.new(9, 'Clubs'),
                                                      Card.new(3, 'Clubs'),
...
hand_straight_ace_high = PokerHand.new(DeckMock.create([
                                                         Card.new('Queen', 'Clubs'),
                                                         Card.new('King', 'Diamonds'),
                                                         Card.new(10, 'Clubs'),
                                                         Card.new('Ace', 'Hearts'),
...
hand_straight_jack_high = PokerHand.new(DeckMock.create([
                                                          Card.new(8, 'Clubs'),
                                                          Card.new(9, 'Diamonds'),
                                                          Card.new(10, 'Clubs'),
                                                          Card.new(7, 'Hearts'),
...
hand_three_of_a_kind = PokerHand.new(DeckMock.create([
                                                       Card.new(3, 'Hearts'),
                                                       Card.new(3, 'Clubs'),
                                                       Card.new(5, 'Diamonds'),
                                                       Card.new(3, 'Spades'),
...
hand_two_pair = PokerHand.new(DeckMock.create([
                                                Card.new(9, 'Hearts'),
                                                Card.new(9, 'Clubs'),
                                                Card.new(5, 'Diamonds'),
                                                Card.new(8, 'Spades'),
...
hand_pair = PokerHand.new(DeckMock.create([
                                            Card.new(2, 'Hearts'),
                                            Card.new(9, 'Clubs'),
                                            Card.new(5, 'Diamonds'),
                                            Card.new(9, 'Spades'),
...
hand_ace_high = PokerHand.new(DeckMock.create([
                                                Card.new(2, 'Hearts'),
                                                Card.new('Ace', 'Clubs'),
                                                Card.new(5, 'Diamonds'),
                                                Card.new(9, 'Spades'),
...
hand_king_clubs_high = PokerHand.new(DeckMock.create([
                                                       Card.new(2, 'Hearts'),
                                                       Card.new('King', 'Clubs'),
                                                       Card.new(5, 'Diamonds'),
                                                       Card.new(9, 'Spades'),
...
hand_king_hearts_high = PokerHand.new(DeckMock.create([
                                                        Card.new(2, 'Hearts'),
                                                        Card.new('King', 'Hearts'),
                                                        Card.new(5, 'Diamonds'),
                                                        Card.new(9, 'Spades'),
